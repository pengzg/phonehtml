tempApp.controller('ctr_cutParticipantsList', ['$scope','dateUtil','messageFactory','http','$state','EzConfirm','activityFactory','$rootScope','$stateParams',
function($scope,dateUtil,messageFactory,http,$state,EzConfirm,activityFactory,$rootScope,$stateParams) {
  $scope.pager = {page:1,rows:'20',sort:'pcp_addtime',order:'desc',pageList:['10','20','30'],pc_shopid:$rootScope.USER.shopId};
