tempApp.controller('ctr_houseList', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {
     ...
     * 查询订单列表
     */
    $scope.pager = {page:1,rows:'20',sort:'cb_sort',order:'desc',om_order_type:'2',pageList:['10','20','30']};
...
$scope.selectTab = function(x) {
    ...
    $scope.goEdit = function(x){
        var url = "";
        url = $state.href('index.house.houseAdd',{"cb_id":x.cb_id});
