tempApp.controller('ctr_baseMaterial', function($scope,$stateParams,$state,http,EzConfirm,messageFactory,dateUtil,$timeout,$rootScope) {
	$scope.pager = {page:1,rows:'20',sort:'bm_sort Desc,bm_addtime',order:' DESC',pageList:['10','20','30']};
	...
	var queryList = function(){
		...
		var url = '/admin/base/baseMaterialControl/dataGrid.action';
	...
	$scope.clearParams = function(){
		...
		$scope.searchParam.bm_location='';
		$scope.searchParam.bm_type='';
		$scope.searchParam.bm_checkstate='';
		$scope.searchParam.bm_state='';
		$('#start_date').val($scope.dateNow);
		$('#end_date').val($scope.dateNow);
	}
	...
	$scope.updateState = function(x, state) {
    	...
    	var data = {"bm_id":x.bm_id,"bm_state":state};
		var url = "/admin/base/baseMaterialControl/updateState.action" ;
	...
	$scope.goEdit = function(x){
		var url = "";
		url = $state.href("index.setup.basematerialadd",{"bm_id":x.bm_id});
	...
	$scope.updateCheckstate = function(checkstate) {
    	...
    	var data = {"bm_id":$scope.vo.bm_id,"bm_checkstate":checkstate,"bm_checkcomment": $("#comment").val()};
