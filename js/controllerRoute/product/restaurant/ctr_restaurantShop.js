tempApp.controller('ctr_restaurantShop', function($scope,
    $state,$stateParams,http,EzConfirm,messageFactory,$rootScope) {
$scope.pager = {page:1,rows:'20',sort:'rs_sort',order:'desc',pageList:['10','20','30'],rs_shopid:$rootScope.USER.shopId};
$scope.searchParam = {};
$scope.vo = {};
if($stateParams){
...
$scope.clearParams = function(){
   ...
   $scope.goEdit = function(x){
       var url = "";
       url = $state.href('index.product.restaurantShopAdd',{'rs_id':x.rs_id});
   ...
   /**
	...
	$scope.updateState = function(x, state) {
    	...
    	var data = {"rs_id":x.rs_id,"rs_state":state};
		var url = "/admin/restaurant/restaurantShopControl/updateState.action" ;
