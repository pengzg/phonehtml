tempApp.controller('ctr_glAgentProductRel', function($scope,EzConfirm,messageFactory,http,$state,$stateParams,$rootScope) {
	 ...
	 * 查询列表
	 */
	$scope.pager = {page:1,rows:'20','gapr_dr':'1',sort:'gapr_ts',order:'desc',pageList:['10','20','30'],gapr_shopid:$rootScope.USER.shopId};
	...
	$scope.addRelation = function(){
		$state.go("index.gl.glagentproductreladd");
	}
	...
	$scope.deleteRelation = function(x) {
		...
		var url = '/admin/gl/glAgentProductRelControl/delete.action';
		var data = {"gapr_id":x.gapr_id};
