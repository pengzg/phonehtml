tempApp.controller('ctr_exportExchangeTicket', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {

    $scope.pager = {page:1,rows:'20',sort:'memberid',order:'desc',pageList:['10','20','30'],shopid:$rootScope.USER.shopId};
    $scope.searchParam = {storeid:"", productSearchKey:"", memberMobileSearchKey:"",memberNameSearchKey:"", tm_def1:"4"};
