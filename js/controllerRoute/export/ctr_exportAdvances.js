tempApp.controller('ctr_exportAdvances', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {

    $scope.pager = {page:1,rows:'20',sort:'memberid',order:'desc',pageList:['10','20','30'],shopid:$rootScope.USER.shopId};
    ...
    $scope.queryList = function(){
        ...
        var url = '/admin/order/orderExportControl/exportAdvances.action';
  ...
  /**
    ...
    $scope.doExport = function(){
		...
		var url = '/admin/order/orderExportControl/doExportAdvances.action?'+str;
