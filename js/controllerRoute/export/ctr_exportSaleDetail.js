tempApp.controller('ctr_exportSaleDetail', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {

    $scope.pager = {page:1,rows:'20',sort:'',order:'',pageList:['10','20','30'],shopid:$rootScope.USER.shopId};
    ...
    $scope.queryList = function(){
        ...
        var url = '/admin/order/orderExportControl/exportSaleDetail.action';
    ...
    $scope.doExport = function(){
		...
		var url = '/admin/order/orderExportControl/doExportSaleDetail.action?'+str;
