tempApp.controller('ctr_memberGiftList', function($scope,
    $state,$stateParams,http,EzConfirm,messageFactory,$rootScope) {
$scope.pager = {page:1,rows:'20',sort:'mg_ts',"mg_dr":1,order:'desc',pageList:['10','20','30'],mg_shopid:$rootScope.USER.shopId};
$scope.searchParam = {};
