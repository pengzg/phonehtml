tempApp.controller('ctr_orderListQy', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {
  ...
  /**
	...
	$scope.goOrderDetail = function(id,code){
		var url = "";
		url = $state.href('index.order.orderDetailQy',{'om_id':id,'om_order_code':code});
	...
	$scope.queryDckGoodsList = function(id,storeId){
		...
		var data = {'om_id':id,'store_id':"no-store"};
		http.post(url,data,success,error);
	}
	...
	$scope.saveDelivery = function(){
		...
		var url = "/admin/order/orderDetailControl/insertOrderDeliveryNoStore.action";
		var data = {
