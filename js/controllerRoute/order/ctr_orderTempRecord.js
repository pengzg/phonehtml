tempApp.controller('ctr_orderTempRecord', function($scope,
    $state,http,EzConfirm,messageFactory,$rootScope) {
$scope.pager = {page:1,rows:'20',sort:'otr_addtime',order:'desc',pageList:['10','20','30'],otr_shopid:$rootScope.USER.shopId};
$scope.searchParam = {};
$scope.vo = {};
$scope.showPic = false;
...
$scope.changeState = function(state){
	...
	$scope.getStoreHouse = function(){
		...
		http.post(url,{searchKey:"", "bs_type":4, "bs_is_virtual":2},success,error);
	}
	$scope.getStoreHouse();
