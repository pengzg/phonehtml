tempApp.controller('ctr_orderList', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {

  $scope.pager = {page:1,rows:'20',sort:'om_order_time',order:'desc',om_order_type:'2',pageList:['10','20','30'],om_shopid:$rootScope.USER.shopId};
  $scope.searchParam = {};
  ...
  $scope.hideItem = function(){
	...
	$scope.bindAgent = function(x) {
		...
		var data ={'om_id':$scope.upOrder.orderMainVO.om_id, "om_agentsale_id":x.mb_agentid_sale}
		var url = "/admin/order/orderMainControl/updateAgentsaleId.action";
