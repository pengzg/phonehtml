tempApp.controller('ctr_glCashApply', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {
    ...
    var queryList = function(){
        ...
        var url = '/admin/gl/glCashApplyControl/dataGrid.action';
