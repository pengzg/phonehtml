tempApp.controller('ctr_ticketListStats', function($scope,
	...
	var queryTicket = function(){
		...
		var url = '/admin/ticket/ticketMainControl/dataGridTicketStats.action';
    ...
    $scope.doExport = function(){
		...
		var url = '/admin/ticket/ticketMainControl/doExportTicketStats.action?'+str;
